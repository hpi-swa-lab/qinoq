...
class InteractiveScrollHolder extends Morph {
  ...
  onMouseMove (event) {
    ...
    if (this.currentMouseTarget) {
      ...
      if (this.topbar)(this.topbar.editMode == 'Text' || this.topbar.editMode == 'Shape') ? this.nativeCursor = 'crosshair' : this.nativeCursor = this.currentMouseTarget.nativeCursor;
    }
