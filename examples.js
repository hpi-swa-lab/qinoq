...
export function skyExample () {
  ...
  // The animation is generated by default, we just need to edit it
  const starProgressAnimation = skySequence.getAnimationForMorphProperty(stars, 'progress');
  starProgressAnimation.keyframes[1].position = 0.1;
